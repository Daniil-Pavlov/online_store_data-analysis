...
Целью работы было расчет основных метрик по данным работы сервиса доставки еды у которого имеется услуга доставки и их последующая визуализация.
1 Расчет метрик оценки аудитории сервиса.
2.1 Расчет экономических метрик сервиса.
2.2 Расчет маркетинговые метрик сервиса.
