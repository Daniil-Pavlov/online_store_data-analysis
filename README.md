...
## Основные цели 
  В сервис по покупке продуктов питания была добавлена функция оформления доставки заказа на дом через приложение либо веб-версию. Также для привлечения клиентов параллельно было запущено 2 рекламные компании. В связи с этим возникла потребность в оценке проведенных изменений. 
  
  Необходимо было расчетать основные метрик по данным работы сервиса  и их последующая визуализация. <br>
#### Этапы работы:
